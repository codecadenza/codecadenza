...
### Fixed
2026-04-08: Do not add the primary key of a table as an index when performing the database synchronization
2026-04-08: Avoid creating duplicate foreign keys and indexes when performing a reverse engineering job
...
### Changed
2026-03-05: Fix wrong exception logging in the REST exception mapper
...
2026-01-30: Catch a NoClassDefFoundError in database connection tests
2026-01-30: Add missing tabs in generated web.xml files for JSF applications
2026-01-27: Declare unnamed patterns, local variables and exception parameters
2026-01-27: Update to Java 25, Jakarta EE 11 and Spring Boot 4
2026-01-27: Remove unused named query fragments in the domain object generator
2026-01-27: Remove unnecessary toString() invocations
