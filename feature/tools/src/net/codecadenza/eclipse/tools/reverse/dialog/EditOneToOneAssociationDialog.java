...
/**
 * <p>
 * Dialog for maintaining one-to-one associations
 * </p>
 * <p>
...
public class EditOneToOneAssociationDialog extends CodeCadenzaDialog {
	...
	private static final String DLG_TITLE = "Edit one-to-one association";
	 ...
	 * @param revEngAssoc
	 */
	public EditOneToOneAssociationDialog(Shell parentShell, RevEngDomainAssociation revEngAssoc) {
		super(parentShell);

		this.association = (OneToOneAssociation) revEngAssoc.getAssociation();
