...
/**
 * <p>
 * Implementation of a JPA text viewer widget
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class JPATextViewer extends SourceViewer {
	private IPresentationReconciler presentationReconciler;
	private IDocumentPartitioner partitioner;
	private JPATextTools jpaTextTools;
	private IContentAssistant contentAssistant;
	private JPASourceViewerConfiguration configuration;
	 ...
	 * @param syntax
	 */
	public JPATextViewer(Composite parent, int style, JPASyntax syntax) {
	 ...
	 * @param ruler
	 */
	public JPATextViewer(Composite parent, int style, JPASyntax syntax, IVerticalRuler ruler) {
		...
		configuration = new JPASourceViewerConfiguration(syntax, jpaTextTools);
	 ...
	 * @param syntax
	 */
	public void refresh(JPASyntax syntax) {
		if (contentAssistant != null) {
			contentAssistant.uninstall();
