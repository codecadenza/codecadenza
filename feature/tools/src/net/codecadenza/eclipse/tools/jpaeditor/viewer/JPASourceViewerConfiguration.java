...
/**
 * <p>
 * Configuration of a JPA source viewer
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class JPASourceViewerConfiguration extends SourceViewerConfiguration {
	private InformationPresenter presenter;
	private final JPATextTools tools;
	...
	/**
	 * Create a new JPA source viewer configuration
	 * @param syntax the SQL syntax to be used
	 * @param tools the SQL tools to be used
	 */
	public JPASourceViewerConfiguration(JPASyntax syntax, JPATextTools tools) {
		this.tools = tools;
		this.syntax = syntax;
	...
	public IContentAssistant getContentAssistant(ISourceViewer sourceViewer) {
		...
		final var processor = new JPACompletionProcessor(syntax);
