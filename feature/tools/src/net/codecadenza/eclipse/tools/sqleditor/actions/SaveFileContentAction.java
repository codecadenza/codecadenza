...
public class SaveFileContentAction extends AbstractEditorAction {
	 ...
	 * @param editor
	 */
	public SaveFileContentAction(SQLEditor editor) {
		super(editor);
	}
	...
	/*
	 * (non-Javadoc)
	 * @see net.codecadenza.eclipse.tools.sqleditor.actions.AbstractEditorAction#getText()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see net.codecadenza.eclipse.tools.sqleditor.actions.AbstractEditorAction#run()
	 */
	@Override
	public void run() {
		editor.doSave(null);
