...
/**
 * <p>
 * Tools required to configure a JFace text viewer
 * </p>
 * <p>
...
public class SQLTextTools {
	private SQLCodeScanner codeScanner;
	 ...
	 * @param syntax
	 */
	public SQLTextTools(SQLSyntax syntax) {
		codeScanner = new SQLCodeScanner(syntax);
	...
	/**
	 * Create the document partitioner
