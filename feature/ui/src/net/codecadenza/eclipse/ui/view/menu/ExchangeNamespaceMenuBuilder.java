...
/**
 * <p>
 * Helper class to create a context menu for tree view items that represent data exchange namespaces
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class ExchangeNamespaceMenuBuilder extends AbstractMenuBuilder<Namespace> {
	/**
	 * Constructor
	 * @param view
	 * @param tree
	 */
	public ExchangeNamespaceMenuBuilder(ProjectView view, Tree tree) {
		super(view, tree);
	}
	...
	public Menu createMenu() {
		...
		// Add a menu item to create a new data exchange method
		final var itemAdd = new MenuItem(menuExchange, SWT.NONE);
		itemAdd.setText(TITLE_NEW_EXCHANGE_METHOD);
		...
		itemAdd.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				new EditExchangeMethodDialog(shell, project).open();
