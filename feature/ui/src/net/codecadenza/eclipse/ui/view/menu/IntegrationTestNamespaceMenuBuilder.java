...
/**
 * <p>
 * Helper class to create a context menu for tree view items that represent integration test modules
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class IntegrationTestNamespaceMenuBuilder extends AbstractMenuBuilder<Namespace> {
	/**
	 * Constructor
	 * @param view
	 * @param tree
	 */
	public IntegrationTestNamespaceMenuBuilder(ProjectView view, Tree tree) {
		super(view, tree);
	}
	...
	public Menu createMenu() {
		final var menuTestModule = new Menu(tree);

		// Add a menu item to create a new test case
		final var itemAddTestCase = new MenuItem(menuTestModule, SWT.NONE);
		...
		itemAddTestCase.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				for (final AbstractTestModule testModule : project.getTestModules())
					if (testModule.getNamespace().equals(namespace)) {
						new EditIntegrationTestCaseDialog(shell, (IntegrationTestModule) testModule).open();
						break;
					}
