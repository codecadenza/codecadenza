...
/**
 * <p>
 * Preview generator for text fields
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class TextPreviewBuilder extends AbstractVisualEditorFieldPreviewBuilder {
	/**
	 * Constructor
	 ...
	 * @param formPanel
	 */
	public TextPreviewBuilder(VisualFormEditorPreviewBuilder previewBuilder, FormField formField, Composite formPanel) {
	...
	public Control getFieldPreview(Control lblField) {
		...
		if (formField.getDefaultValue() != null && !formField.getDefaultValue().isEmpty())
			txtInput.setText(formField.getDefaultValue());
