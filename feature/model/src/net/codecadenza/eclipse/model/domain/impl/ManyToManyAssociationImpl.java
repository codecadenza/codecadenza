...
/**
 * An implementation of the model object '<em><b>Many To Many Association</b></em>'.
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link net.codecadenza.eclipse.model.domain.impl.ManyToManyAssociationImpl#getTable <em>Table</em>}</li>
 * </ul>
 * </p>
 * @generated
 */
public class ManyToManyAssociationImpl extends AbstractDomainAssociationImpl implements ManyToManyAssociation {
	/**
	 ...
	 * @generated
	 */
	protected ManyToManyAssociationImpl() {
	}
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.MANY_TO_MANY_ASSOCIATION;
	}
	...
	public NotificationChain basicSetTable(DBTable newTable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			final var notification = new ENotificationImpl(this, Notification.SET, DomainPackage.MANY_TO_MANY_ASSOCIATION__TABLE,
					oldTable, newTable);
	...
	/*
	 * (non-Javadoc)
	 * @see net.codecadenza.eclipse.model.domain.ManyToManyAssociation#setTable(net.codecadenza.eclipse.model.db.DBTable)
	 * @generated
	 */
	@Override
		...
		if (newTable != table) {
			...
			if (table != null)
				msgs = ((InternalEObject) table).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DomainPackage.MANY_TO_MANY_ASSOCIATION__TABLE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.MANY_TO_MANY_ASSOCIATION__TABLE, newTable, newTable));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DomainPackage.MANY_TO_MANY_ASSOCIATION__TABLE:
	...
	/*
	 * (non-Javadoc)
	 * @see net.codecadenza.eclipse.model.domain.ManyToManyAssociation#isBidirectional()
	 * @generated not
	 */
	@Override
	 ...
	 */
	@Override
	public ManyToManyAssociation getReverseAssociation() {
		return (ManyToManyAssociation) super.getReverseAssociation();
	}
