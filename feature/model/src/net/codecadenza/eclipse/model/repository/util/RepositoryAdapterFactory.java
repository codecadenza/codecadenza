...
public class RepositoryAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected RepositorySwitch<Adapter> modelSwitch = new RepositorySwitch<>() {
		/*
		 * (non-Javadoc)
		 * @see
		 * net.codecadenza.eclipse.model.repository.util.RepositorySwitch#caseRepository(net.codecadenza.eclipse.model.repository.
		 * Repository)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see net.codecadenza.eclipse.model.repository.util.RepositorySwitch#caseRepositoryMethod(net.codecadenza.eclipse.model.
		...
		/*
		 * (non-Javadoc)
		 * @see net.codecadenza.eclipse.model.repository.util.RepositorySwitch#caseRepositoryMethodParameter(net.codecadenza.eclipse.
		 * model.repository.RepositoryMethodParameter)
		 */
		@Override
		public Adapter caseRepositoryMethodParameter(RepositoryMethodParameter object) {
			return createRepositoryMethodParameterAdapter();
		}

		/*
		 * (non-Javadoc)
		 * @see net.codecadenza.eclipse.model.repository.util.RepositorySwitch#caseJavaType(net.codecadenza.eclipse.model.java.
		 * JavaType)
		 * @generated
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see net.codecadenza.eclipse.model.repository.util.RepositorySwitch#caseServiceBean(net.codecadenza.eclipse.model.service.
		 * ServiceBean)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see net.codecadenza.eclipse.model.repository.util.RepositorySwitch#caseJavaMethod(net.codecadenza.eclipse.model.java.
		 * JavaMethod)
		 */
		@Override
		 ...
		 * (non-Javadoc)
		 * @see
		 * net.codecadenza.eclipse.model.repository.util.RepositorySwitch#caseServiceMethod(net.codecadenza.eclipse.model.service.
		 * ServiceMethod)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see net.codecadenza.eclipse.model.repository.util.RepositorySwitch#caseMethodParameter(net.codecadenza.eclipse.model.java.
		 * MethodParameter)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see net.codecadenza.eclipse.model.repository.util.RepositorySwitch#defaultCase(org.eclipse.emf.ecore.EObject)
		 */
		@Override
	...
	/**
	 * Create a new adapter for an object of class '{@link net.codecadenza.eclipse.model.repository.Repository
	 * <em>Repository</em>}'. This default implementation returns null so that we can easily ignore cases; it's useful to ignore a
	...
	/**
	 * Create a new adapter for an object of class '{@link net.codecadenza.eclipse.model.repository.RepositoryMethod <em>Repository
	...
	/**
	 * Create a new adapter for an object of class '{@link net.codecadenza.eclipse.model.repository.RepositoryMethodParameter
	 * <em>Repository Method Parameter</em>}'. This default implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * @return the new adapter
	 * @see net.codecadenza.eclipse.model.repository.RepositoryMethodParameter
	 * @generated
	 */
	public Adapter createRepositoryMethodParameterAdapter() {
		return null;
	}
