...
/**
 * An implementation of the model object '<em><b>Tree Search Item</b></em>'.
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link net.codecadenza.eclipse.model.client.impl.TreeSearchItemImpl#getLabel <em>Label</em>}</li>
 * <li>{@link net.codecadenza.eclipse.model.client.impl.TreeSearchItemImpl#getDTOAttribute <em>DTO Attribute</em>}</li>
 * </ul>
 * </p>
 * @generated
 */
public class TreeSearchItemImpl extends EObjectImpl implements TreeSearchItem {
	/**
	...
	protected EClass eStaticClass() {
		return ClientPackage.Literals.TREE_SEARCH_ITEM;
	}
	...
	/*
	 * (non-Javadoc)
	 * @see net.codecadenza.eclipse.model.client.TreeSearchItem#setLabel(java.lang.String)
	 * @generated
	 */
	@Override
	public void setLabel(String newLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClientPackage.TREE_SEARCH_ITEM__LABEL, oldLabel, label));
	}
	...
	public DTOBeanAttribute getDTOAttribute() {
		if (dTOAttribute != null && dTOAttribute.eIsProxy()) {
			...
			if (dTOAttribute != oldDTOAttribute && eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClientPackage.TREE_SEARCH_ITEM__DTO_ATTRIBUTE, oldDTOAttribute,
						dTOAttribute));
		}
	...
	/*
	 * (non-Javadoc)
	 * @see net.codecadenza.eclipse.model.client.TreeSearchItem#setDTOAttribute(net.codecadenza.eclipse.model.dto.DTOBeanAttribute)
	 * @generated
	 */
	@Override
	public void setDTOAttribute(DTOBeanAttribute newDTOAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClientPackage.TREE_SEARCH_ITEM__DTO_ATTRIBUTE, oldDTOAttribute,
					dTOAttribute));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClientPackage.TREE_SEARCH_ITEM__LABEL:
				return getLabel();
			case ClientPackage.TREE_SEARCH_ITEM__DTO_ATTRIBUTE:
				if (resolve)
