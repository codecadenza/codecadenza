 ...
 * @generated
 */
public class BoundarySwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BoundaryPackage.BOUNDARY_BEAN: {
				final var boundaryBean = (BoundaryBean) theEObject;
				T result = caseBoundaryBean(boundaryBean);

				if (result == null)
					result = caseServiceBean(boundaryBean);

				if (result == null)
					result = caseJavaType(boundaryBean);
			...
			case BoundaryPackage.BOUNDARY_METHOD: {
				final var boundaryMethod = (BoundaryMethod) theEObject;
				T result = caseBoundaryMethod(boundaryMethod);

				if (result == null)
					result = caseServiceMethod(boundaryMethod);

				if (result == null)
					result = caseJavaMethod(boundaryMethod);
	...
	/**
	 * Return the result of interpreting the object as an instance of '<em>Boundary Bean</em>'. This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * @param object the target of the switch
	 * @return the result of interpreting the object as an instance of '<em>Boundary Bean</em>'
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	@SuppressWarnings("unused")
	public T caseBoundaryBean(BoundaryBean object) {
		return null;
	}

	/**
	 * Return the result of interpreting the object as an instance of '<em>Boundary Method</em>'. This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * @param object the target of the switch
	 * @return the result of interpreting the object as an instance of '<em>Boundary Method</em>'
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	@SuppressWarnings("unused")
	public T caseBoundaryMethod(BoundaryMethod object) {
		return null;
	}
