...
/**
 * <p>
 * Build module for repository artifacts
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class RepositoryBuildModule extends AbstractBuildModule {
	/**
	 * Constructor
	 * @param buildArtifact
	 */
	public RepositoryBuildModule(BuildArtifact buildArtifact) {
		super(buildArtifact);
	}
	...
	public List<WorkspaceFile> getConfigurationFiles() {
		...
		addBeansXML(configFiles, BuildArtifactType.REPOSITORY);
	...
	public List<String> getPackages() {
		...
		packages.add(project.getRepositoryNamespace().toString());

		project.getDomainNamespace().getChildNamespaces()
				.forEach(ns -> packages.add(project.getRepositoryNamespace().toString() + "." + ns.getName()));
