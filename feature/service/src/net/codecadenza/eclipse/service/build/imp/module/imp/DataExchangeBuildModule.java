...
/**
 * <p>
 * Build module for data exchange artifacts
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class DataExchangeBuildModule extends AbstractBuildModule {
	/**
	 * Constructor
	 * @param buildArtifact
	 */
	public DataExchangeBuildModule(BuildArtifact buildArtifact) {
		super(buildArtifact);
	}
	...
	public List<String> getFolders() {
		...
		if (project.isJavaSEApplication() || project.isSpringBootApplication())
	...
	public List<WorkspaceFile> getConfigurationFiles() {
		...
		addBeansXML(configFiles, BuildArtifactType.DATA_EXCHANGE);
	...
	public List<String> getPackages() {
		...
		packages.add(project.getExchangeNamespace().toString());

		project.getExchangeNamespace().getChildNamespaces().forEach(ns -> packages.add(ns.toString()));
