...
/**
 * <p>
 * Action to edit one-to-one associations
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class EditOneToOneAssociationAction extends AbstractEditDomainObjectAssociationAction {
	/*
	 * (non-Javadoc)
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if (part != null) {
			...
			association = (OneToOneAssociation) edge.getElement();
		}
	}
