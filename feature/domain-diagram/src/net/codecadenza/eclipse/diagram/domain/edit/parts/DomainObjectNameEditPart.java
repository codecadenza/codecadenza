...
/**
 * <p>
 * Edit part for domain object names
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class DomainObjectNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @param view
	 */
	public DomainObjectNameEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		if (parserElement instanceof final DomainObject bean) {
			if (bean.isAbstract() || bean.isMappedSuperClass())
				retImage = CodeCadenzaResourcePlugin.getImage(IMG_ABSTRACT_CLASS);
			else
				retImage = CodeCadenzaResourcePlugin.getImage(IMG_DOMAIN_OBJECT);
		}
	...
	/**
	 * @return the direct edit manager
	 */
