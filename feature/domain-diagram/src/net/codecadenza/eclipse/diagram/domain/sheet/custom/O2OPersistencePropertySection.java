 ...
 * @version 1.0.0
 */
public class O2OPersistencePropertySection extends AbstractPropertySection {
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		column = ((OneToOneAssociation) ((Edge) ((OneToOneAssociationEditPart) input).getModel()).getElement()).getColumn();
	}
