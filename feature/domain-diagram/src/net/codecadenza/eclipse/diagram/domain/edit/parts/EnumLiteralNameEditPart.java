...
/**
 * <p>
 * Enumeration literal name edit part
 * </p>
 * <p>
...
public class EnumLiteralNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	protected Image getLabelIcon() {
		...
		if (parserElement instanceof EnumLiteral)
			retImage = CodeCadenzaResourcePlugin.getImage(IMG_ENUM_LITERAL);
	...
	protected String getLabelText() {
		...
		if (parserElement != null && getParser() != null) {
			final var literal = (EnumLiteral) parserElement;

			if (literal.getTag() == EnumLiteralTagEnumeration.NONE)
				text = literal.getName();
			else
				text = literal.getName() + " [" + literal.getTag().getName() + "]";
		}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			final var hintAdapter = new CodeCadenzaParserProvider.HintAdapter(CodeCadenzaElementTypes.EnumLiteral_3002, getParserElement(),
					parserHint);
