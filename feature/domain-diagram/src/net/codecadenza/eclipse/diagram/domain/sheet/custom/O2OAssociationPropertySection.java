...
/**
 * <p>
 * Property section for one-to-one associations
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class O2OAssociationPropertySection extends AbstractPropertySection {
	...
	private OneToOneAssociationEditPart part;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		this.part = (OneToOneAssociationEditPart) input;
		this.association = (OneToOneAssociation) ((Edge) ((OneToOneAssociationEditPart) input).getModel()).getElement();
	}
