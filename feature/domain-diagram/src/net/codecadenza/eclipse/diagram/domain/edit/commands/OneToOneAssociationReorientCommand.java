...
/**
 * <p>
 * Command to re-orient a one-to-one association
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class OneToOneAssociationReorientCommand extends EditElementCommand {
	 ...
	 * @param request
	 */
	public OneToOneAssociationReorientCommand(ReorientRelationshipRequest request) {
	 ...
	 * @return the link
	 */
	protected OneToOneAssociation getLink() {
		return (OneToOneAssociation) getElementToEdit();
	}
