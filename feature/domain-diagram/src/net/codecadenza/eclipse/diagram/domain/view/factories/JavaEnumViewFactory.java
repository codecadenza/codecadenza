...
/**
 * <p>
 * View factory for enumeration views
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class JavaEnumViewFactory extends AbstractShapeViewFactory {
	/*
	 * (non-Javadoc)
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index,
		...
		if (semanticHint == null) {
			semanticHint = CodeCadenzaVisualIDRegistry.getType(JavaEnumEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view, CodeCadenzaVisualIDRegistry.getType(JavaEnumNameEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(eObjectAdapter, view,
				CodeCadenzaVisualIDRegistry.getType(JavaEnumEnumerationLiteralCompartmentEditPart.VISUAL_ID), ViewUtil.APPEND, true,
				getPreferencesHint());
	}
