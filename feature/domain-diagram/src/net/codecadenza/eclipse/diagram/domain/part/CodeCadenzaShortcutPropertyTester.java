 ...
 * @version 1.0.0
 */
public class CodeCadenzaShortcutPropertyTester extends PropertyTester {
	...
	public boolean test(Object receiver, String method, Object[] args, Object expectedValue) {
		if (!(receiver instanceof final View view))
			return false;
		...
		if (SHORTCUT_PROPERTY.equals(method)) {
			...
			if (annotation != null)
				return DomainNamespaceEditPart.MODEL_ID.equals(annotation.getDetails().get("modelID"));
		}
