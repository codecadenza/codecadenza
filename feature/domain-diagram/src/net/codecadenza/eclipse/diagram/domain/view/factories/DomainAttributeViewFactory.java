...
/**
 * <p>
 * View factory for domain attribute views
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class DomainAttributeViewFactory extends AbstractShapeViewFactory {
	/*
	 * (non-Javadoc)
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index,
		...
		if (semanticHint == null) {
			semanticHint = CodeCadenzaVisualIDRegistry.getType(DomainAttributeEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view, CodeCadenzaVisualIDRegistry.getType(DomainAttributeNameEditPart.VISUAL_ID),
