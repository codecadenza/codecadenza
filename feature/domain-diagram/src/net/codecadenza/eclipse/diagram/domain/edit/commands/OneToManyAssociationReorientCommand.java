 ...
 * @version 1.0.0
 */
public class OneToManyAssociationReorientCommand extends EditElementCommand {
	 ...
	 * @param request
	 */
	public OneToManyAssociationReorientCommand(ReorientRelationshipRequest request) {
	 ...
	 * @return the link
	 */
	protected OneToManyAssociation getLink() {
		return (OneToManyAssociation) getElementToEdit();
	}
