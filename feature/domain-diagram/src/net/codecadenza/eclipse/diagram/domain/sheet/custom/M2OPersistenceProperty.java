 ...
 * @version 1.0.0
 */
public class M2OPersistenceProperty extends AbstractPropertySection {
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		column = ((ManyToOneAssociation) ((Edge) ((ManyToOneAssociationEditPart) input).getModel()).getElement()).getColumn();
	}
