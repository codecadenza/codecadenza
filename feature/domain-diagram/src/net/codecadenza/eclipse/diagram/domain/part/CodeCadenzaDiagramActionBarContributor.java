 ...
 * @version 1.0.0
 */
public class CodeCadenzaDiagramActionBarContributor extends DiagramActionBarContributor {
	/*
	 * (non-Javadoc)
	...
	protected Class<?> getEditorClass() {
		return CodeCadenzaDiagramEditor.class;
	}
	...
	protected String getEditorId() {
		return CodeCadenzaDiagramEditor.ID;
	}
