...
/**
 * <p>
 * View factory for one-to-one association views
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class OneToOneAssociationViewFactory extends ConnectionViewFactory {
	/*
	 * (non-Javadoc)
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index,
		...
		if (semanticHint == null) {
			semanticHint = CodeCadenzaVisualIDRegistry.getType(OneToOneAssociationEditPart.VISUAL_ID);
