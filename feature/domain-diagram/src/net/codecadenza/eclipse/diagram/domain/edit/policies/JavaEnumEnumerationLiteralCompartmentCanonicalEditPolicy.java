 ...
 * @version 1.0.0
 */
public class JavaEnumEnumerationLiteralCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List<EObject> getSemanticChildrenList() {
		...
		for (final CodeCadenzaNodeDescriptor nodeDescriptor : CodeCadenzaDiagramUpdater
				.getJavaEnumEnumerationLiteralCompartment_7002SemanticChildren(viewObject))
	...
	protected Set<EStructuralFeature> getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(JavaPackage.eINSTANCE.getJavaEnum_EnumerationValues());
		}
