...
/**
 * <p>
 * Action to edit one-to-many associations
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class EditOneToManyAssociationAction extends AbstractEditDomainObjectAssociationAction {
	/*
	 * (non-Javadoc)
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if (part != null) {
			...
			association = (OneToManyAssociation) edge.getElement();
		}
	}
