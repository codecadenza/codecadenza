...
import net.codecadenza.eclipse.diagram.domain.edit.policies.ManyToOneAssociationItemSemanticEditPolicy;
...
/**
 * <p>
 * Edit part for many-to-one associations
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class ManyToOneAssociationEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	 ...
	 * @param view
	 */
	public ManyToOneAssociationEditPart(View view) {
		super(view);

		association = (ManyToOneAssociation) view.getElement();
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ManyToOneAssociationItemSemanticEditPolicy());
	}
	...
	protected Connection createConnectionFigure() {
		return new ManyToOneAssociationFigure();
	}

	/**
	 * @return the primary shape
	 */
	public ManyToOneAssociationFigure getPrimaryShape() {
		return (ManyToOneAssociationFigure) getFigure();
	}

	public class ManyToOneAssociationFigure extends PolylineConnectionEx {
		/**
		 * Constructor
		 */
		public ManyToOneAssociationFigure() {
