...
/**
 * <p>
 * Command to re-orient a many-to-one association
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class ManyToOneAssociationReorientCommand extends EditElementCommand {
	 ...
	 * @param request
	 */
	public ManyToOneAssociationReorientCommand(ReorientRelationshipRequest request) {
	 ...
	 * @return the link
	 */
	protected ManyToOneAssociation getLink() {
		return (ManyToOneAssociation) getElementToEdit();
	}
