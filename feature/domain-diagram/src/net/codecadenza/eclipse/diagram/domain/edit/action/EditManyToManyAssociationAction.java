...
/**
 * <p>
 * Action to edit many-to-many associations
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class EditManyToManyAssociationAction extends AbstractEditDomainObjectAssociationAction {
	/*
	 * (non-Javadoc)
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if (part != null) {
			...
			association = (ManyToManyAssociation) edge.getElement();
		}
	}
