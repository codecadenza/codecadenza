...
/**
 * <p>
 * View factory for enumeration association views
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class EnumAssociationViewFactory extends ConnectionViewFactory {
	/*
	 * (non-Javadoc)
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index,
		...
		if (semanticHint == null) {
			semanticHint = CodeCadenzaVisualIDRegistry.getType(EnumAssociationEditPart.VISUAL_ID);
