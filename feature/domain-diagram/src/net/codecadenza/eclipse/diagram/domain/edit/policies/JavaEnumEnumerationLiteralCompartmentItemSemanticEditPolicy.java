...
import net.codecadenza.eclipse.diagram.domain.edit.commands.EnumLiteralCreateCommand;
 ...
 * @version 1.0.0
 */
public class JavaEnumEnumerationLiteralCompartmentItemSemanticEditPolicy extends CodeCadenzaBaseItemSemanticEditPolicy {
	/*
	 * (non-Javadoc)
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (CodeCadenzaElementTypes.EnumLiteral_3002 == req.getElementType()) {
			if (req.getContainmentFeature() == null)
				req.setContainmentFeature(JavaPackage.eINSTANCE.getJavaEnum_EnumerationValues());
