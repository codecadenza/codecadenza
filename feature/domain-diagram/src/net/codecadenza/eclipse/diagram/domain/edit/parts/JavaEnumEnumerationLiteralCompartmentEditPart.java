...
import net.codecadenza.eclipse.diagram.domain.edit.policies.JavaEnumEnumerationLiteralCompartmentCanonicalEditPolicy;
import net.codecadenza.eclipse.diagram.domain.edit.policies.JavaEnumEnumerationLiteralCompartmentItemSemanticEditPolicy;
...
/**
 * <p>
 * Enumeration literal compartment edit part
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class JavaEnumEnumerationLiteralCompartmentEditPart extends ListCompartmentEditPart {
	public static final int VISUAL_ID = 7002;

	/**
	 * @param view
	 */
	public JavaEnumEnumerationLiteralCompartmentEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.JavaEnumEnumerationLiteralCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new JavaEnumEnumerationLiteralCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new JavaEnumEnumerationLiteralCompartmentCanonicalEditPolicy());
	}
