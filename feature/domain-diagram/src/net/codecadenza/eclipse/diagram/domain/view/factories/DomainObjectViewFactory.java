...
/**
 * <p>
 * View factory for domain object views
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class DomainObjectViewFactory extends AbstractShapeViewFactory {
	/*
	 * (non-Javadoc)
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index,
		...
		if (semanticHint == null) {
			semanticHint = CodeCadenzaVisualIDRegistry.getType(DomainObjectEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view, CodeCadenzaVisualIDRegistry.getType(DomainObjectNameEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(eObjectAdapter, view,
				CodeCadenzaVisualIDRegistry.getType(DomainAttributeCompartmentEditPart.VISUAL_ID), ViewUtil.APPEND, true,
				getPreferencesHint());
	}
