 ...
 * @version 1.0.0
 */
public class DomainObjectInheritanceReorientCommand extends EditElementCommand {
	 ...
	 * @param request
	 */
	public DomainObjectInheritanceReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		// Re-orienting of an association is not supported
		return false;
	}
	 ...
	 * @return the link
	 */
	protected DomainInheritance getLink() {
		return (DomainInheritance) getElementToEdit();
	}
