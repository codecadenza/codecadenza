...
/**
 * <p>
 * View factory for one-to-many association views
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class OneToManyAssociationViewFactory extends ConnectionViewFactory {
	/*
	 * (non-Javadoc)
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index,
		...
		if (semanticHint == null) {
			semanticHint = CodeCadenzaVisualIDRegistry.getType(OneToManyAssociationEditPart.VISUAL_ID);
