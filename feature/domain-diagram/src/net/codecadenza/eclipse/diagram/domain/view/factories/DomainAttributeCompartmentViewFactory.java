...
/**
 * <p>
 * View factory for domain attribute compartment views
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class DomainAttributeCompartmentViewFactory extends BasicNodeViewFactory {
	/*
	 * (non-Javadoc)
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index,
		...
		if (semanticHint == null) {
			semanticHint = CodeCadenzaVisualIDRegistry.getType(DomainAttributeCompartmentEditPart.VISUAL_ID);
