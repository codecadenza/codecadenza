...
/**
 * <p>
 * Command to re-orient a many-to-many association
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class ManyToManyAssociationReorientCommand extends EditElementCommand {
	 ...
	 * @param request
	 */
	public ManyToManyAssociationReorientCommand(ReorientRelationshipRequest request) {
	...
	protected CommandResult reorientSource() {
		getLink().setDomainObject(getNewSource());
	 ...
	 * @return the link
	 */
	protected ManyToManyAssociation getLink() {
		return (ManyToManyAssociation) getElementToEdit();
	}
	 ...
	 */
	protected DomainObject getOldTarget() {
		return (DomainObject) oldEnd;
	}
	 ...
	 */
	protected DomainObject getNewTarget() {
		return (DomainObject) newEnd;
	}
