...
/**
 * <p>
 * View factory for many-to-many association views
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class ManyToManyAssociationViewFactory extends ConnectionViewFactory {
	/*
	 * (non-Javadoc)
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index,
		...
		if (semanticHint == null) {
			semanticHint = CodeCadenzaVisualIDRegistry.getType(ManyToManyAssociationEditPart.VISUAL_ID);
