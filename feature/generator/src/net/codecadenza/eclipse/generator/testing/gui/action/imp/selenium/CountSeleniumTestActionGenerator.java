...
/**
 * <p>
 * Generator for test actions that perform a count operation
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class CountSeleniumTestActionGenerator extends AbstractSeleniumTestActionGenerator {
	/**
	 * Constructor
	 * @param testAction
	 * @param project
	 * @param declarations
	 */
	public CountSeleniumTestActionGenerator(GUITestAction testAction, Project project, Set<String> declarations) {
	...
	public String createTestAction() {
		...
		b.append(form.getLowerCaseName() + ".performCountOperation(testData.getElementTestData());\n");
