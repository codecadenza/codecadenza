...
/**
 * <p>
 * Generator for test actions that reset a search input dialog
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class ResetSearchSeleniumTestActionGenerator extends AbstractSeleniumTestActionGenerator {
	/**
	 * Constructor
	 * @param testAction
	 * @param project
	 * @param declarations
	 */
	public ResetSearchSeleniumTestActionGenerator(GUITestAction testAction, Project project, Set<String> declarations) {
	...
	public String createTestAction() {
		...
		b.append(form.getLowerCaseName() + ".resetSearchSettings();\n");
