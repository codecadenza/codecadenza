...
/**
 * <p>
 * Generator for test actions that perform a logout operation
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class LogoutSeleniumTestActionGenerator extends AbstractSeleniumTestActionGenerator {
	/**
	 * Constructor
	 * @param testAction
	 * @param project
	 * @param declarations
	 */
	public LogoutSeleniumTestActionGenerator(GUITestAction testAction, Project project, Set<String> declarations) {
	...
	public String createTestAction() {
		...
		b.append(form.getLowerCaseName() + ".pressLogoutButton();\n");
