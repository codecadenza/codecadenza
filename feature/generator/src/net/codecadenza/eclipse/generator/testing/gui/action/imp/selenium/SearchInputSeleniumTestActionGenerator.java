...
/**
 * <p>
 * Generator for test actions that perform a search operation
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class SearchInputSeleniumTestActionGenerator extends AbstractSeleniumTestActionGenerator {
	/**
	 * Constructor
	 * @param testAction
	 * @param project
	 * @param declarations
	 */
	public SearchInputSeleniumTestActionGenerator(GUITestAction testAction, Project project, Set<String> declarations) {
	...
	public String createTestAction() {
		...
		b.append(form.getLowerCaseName() + ".performSearchOperation(testData.getElementTestData());\n");
