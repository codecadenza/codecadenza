...
/**
 * <p>
 * Interface for all generators that create basic source and configuration files for testing
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public interface ITestingProjectFilesGenerator {
	/**
	 * Create basic Java source files for a given test technology
	 * @return a list containing all generated source files
	 */
	List<JavaFile> createSourceFiles();

	/**
	 * Create basic configuration files for a given test technology
