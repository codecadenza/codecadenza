...
/**
 * <p>
 * Generator for boundary methods that count all existing domain objects
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class CountAllBoundaryMethodGenerator extends BasicBoundaryMethodGenerator {
	/**
	 * Constructor
	 * @param method
	 * @param utility
	 ...
	 */
	public CountAllBoundaryMethodGenerator(BoundaryMethod method, IMethodGeneratorUtility utility,
	...
	public String createComment() {
		...
		b.append(" * @return the number of all persistent " + domainObjectPluralLabel + "\n");
		b.append(" */\n");
