...
/**
 * <p>
 * Generator for boundary methods that perform a unique key check
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class ExistsByUniqueKeyBoundaryMethodGenerator extends BasicBoundaryMethodGenerator {
	/**
	 * Constructor
	 * @param method
	 * @param utility
	 ...
	 */
	public ExistsByUniqueKeyBoundaryMethodGenerator(BoundaryMethod method, IMethodGeneratorUtility utility,
	...
	public String createMethodBody() {
		...
		b.append("return " + getRepositoryName() + method.getServiceMethod().getName() + "(");
