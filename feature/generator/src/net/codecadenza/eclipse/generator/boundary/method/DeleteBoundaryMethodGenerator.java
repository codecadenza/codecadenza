...
/**
 * <p>
 * Generator for boundary methods that perform a delete operation
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class DeleteBoundaryMethodGenerator extends BasicBoundaryMethodGenerator {
	 ...
	 */
	public DeleteBoundaryMethodGenerator(BoundaryMethod method, IMethodGeneratorUtility utility,
	...
	public String createComment() {
		...
		b.append(" * @param " + param.getName() + " the ID of the object to be deleted\n");
		b.append(" */\n");
	...
	public String createMethodBody() {
		...
		// Check if a domain attribute exists that represents a document reference!
		for (final DomainAttribute attr : lobAttributeList) {
			...
			for (final RepositoryMethod finderMethod : method.getBoundaryBean().getRepository().getRepositoryMethods())
				if (finderMethod.getMethodType() == RepositoryMethodTypeEnumeration.FIND_EXISTING) {
		...
		for (final DomainAttribute attr : lobAttributeList) {
			...
			b.append("final String path" + pathIndex + " = ");
			b.append(createLOBAttributeGetter(domainObject, domainObjectName, attr) + ";\n");
