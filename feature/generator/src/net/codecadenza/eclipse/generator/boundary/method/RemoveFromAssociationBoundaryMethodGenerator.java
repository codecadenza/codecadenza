...
/**
 * <p>
 * Generator for boundary methods that remove an item from a list
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class RemoveFromAssociationBoundaryMethodGenerator extends BasicBoundaryMethodGenerator {
	/**
	 * Constructor
	 * @param method
	 * @param utility
	 ...
	 */
	public RemoveFromAssociationBoundaryMethodGenerator(BoundaryMethod method, IMethodGeneratorUtility utility,
	...
	public String createMethodBody() {
		return new AddToAssociationBoundaryMethodGenerator(method, generatorUtility, parentGenerator).createMethodBody();
	}
