 ...
 * @version 1.0.0
 */
public class FindByIdBoundaryMethodGenerator extends BasicBoundaryMethodGenerator {
	 ...
	 */
	public FindByIdBoundaryMethodGenerator(BoundaryMethod method, IMethodGeneratorUtility utility,
	...
	public String createComment() {
		...
		b.append(" * @return the " + domainObjectLabel + " object\n");
		b.append(" */\n");
	...
	public String createMethodBody() {
		...
		b.append(getRepositoryName() + method.getServiceMethod().getName() + "(" + param.getName() + ", true);\n\n");
