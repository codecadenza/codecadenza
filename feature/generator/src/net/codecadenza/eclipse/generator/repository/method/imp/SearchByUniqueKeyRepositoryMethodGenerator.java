...
/**
 * <p>
 * Generator for repository methods of type {@link RepositoryMethodTypeEnumeration#SEARCH_BY_UNIQUE_KEY}
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class SearchByUniqueKeyRepositoryMethodGenerator extends BasicRepositoryMethodGenerator {
	/**
	 * Constructor
	 * @param method
	 */
	public SearchByUniqueKeyRepositoryMethodGenerator(RepositoryMethod method) {
		super(method);
	}
	...
	protected String createComment() {
		...
		final var comment = "Search for " + domainObjectLabel + " objects by using the provided parameters";
