...
/**
 * <p>
 * Generator for repository methods of type {@link RepositoryMethodTypeEnumeration#REMOVE_FROM_ASSOCIATION}
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class RemoveFromAssociationRepositoryMethodGenerator extends BasicRepositoryMethodGenerator {
	/**
	 * Constructor
	 * @param method
	 */
	public RemoveFromAssociationRepositoryMethodGenerator(RepositoryMethod method) {
		super(method);
	}
	...
	protected String createComment() {
		...
		b.append("/**\n");
		b.append(" * Remove the persistent " + refBeanLabel + " object from the corresponding list of this ");
		b.append(domainObjectLabel + "\n");
	...
	public String createMethodBody() {
		...
		for (final MethodParameter param : method.getMethodParameters()) {
			...
			if (refPkAttr != null) {
				...
				b.append("{\n");
				b.append("bean." + assocGetter + ".remove(item);\n");
				b.append("return;\n");
				b.append("}\n");
			}
		}
