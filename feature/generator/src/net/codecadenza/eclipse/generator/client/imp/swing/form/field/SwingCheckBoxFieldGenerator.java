 ...
 * @version 1.0.0
 */
public class SwingCheckBoxFieldGenerator extends AbstractSwingFieldGenerator {
	/**
	 * Constructor
	 * @param field
	 * @param formGenerator
	 */
	public SwingCheckBoxFieldGenerator(FormField field, AbstractJavaSourceGenerator formGenerator) {
	...
	public void addFieldDeclaration() {
		...
		formGenerator.addPrivateField("JCheckBox", field.getName()).create();
	}
