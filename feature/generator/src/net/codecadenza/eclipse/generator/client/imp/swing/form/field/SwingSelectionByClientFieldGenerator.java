 ...
 * @version 1.0.0
 */
public class SwingSelectionByClientFieldGenerator extends AbstractSwingFieldGenerator {
	 ...
	 * @param formGenerator
	 */
	public SwingSelectionByClientFieldGenerator(FormField field, AbstractJavaSourceGenerator formGenerator) {
