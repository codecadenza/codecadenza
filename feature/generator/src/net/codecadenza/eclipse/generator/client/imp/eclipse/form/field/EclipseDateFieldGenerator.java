 ...
 * @version 1.0.0
 */
public class EclipseDateFieldGenerator extends AbstractEclipseFieldGenerator {
	 ...
	 * @param formGenerator
	 */
	public EclipseDateFieldGenerator(FormField field, AbstractJavaSourceGenerator formGenerator) {
	...
	public String getValidationFragment(boolean hasTitleArea) {
		...
		final var messageText = "Field \"{0}\" doesn't represent a valid date value!";
		final String validationMessage = i18n.getI18NMessage("msg_err_invalid_date", messageText, FIELD_LABEL_VALIDATION);
