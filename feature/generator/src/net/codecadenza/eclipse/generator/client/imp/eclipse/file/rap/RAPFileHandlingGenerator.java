 ...
 */
package net.codecadenza.eclipse.generator.client.imp.eclipse.file.rap;
...
/**
 * <p>
 * RAP implementation of a generator for handling file content
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class RAPFileHandlingGenerator implements IEclipseFileHandlingGenerator {
	 ...
	 * @param i18n
	 */
	public RAPFileHandlingGenerator(AbstractJavaSourceGenerator formGenerator, BoundaryMethod method,
	 ...
	 * @param i18n
	 */
	public RAPFileHandlingGenerator(AbstractJavaSourceGenerator formGenerator, FormAction action, RichClientI18NGenerator i18n) {
	...
	public String createDownloadFragment(String invocationParameter) {
		...
		if (!project.isJavaSEApplication()) {
			...
			b.append("}\n\n");
			b.append("/* (non-Javadoc)\n");
			b.append(" * @see net.codecadenza.runtime.richclient.eclipse.action.__AbstractFileDownloadOperation#");
			b.append("onDownloadFinished(java.lang.String)\n");
			b.append(" */\n");
			b.append("@Override\n");
			b.append("public void onDownloadFinished(String path) throws Exception\n");
			b.append("{\n");
			b.append("Display.getDefault().syncExec(() ->\n");
			b.append("{\n");
			b.append("final String downloadURL = DownloadServiceHandler.createURL(path);\n\n");
			b.append("final UrlLauncher launcher = RWT.getClient().getService(UrlLauncher.class);\n");
			b.append("launcher.openURL(downloadURL);\n");
			b.append("});\n");
			b.append("}\n");
			b.append("};\n\n");
			b.append("// It is in the responsibility of the application developer ");
			b.append("to define meaningful values for prefix and suffix!\n");
			b.append("downloadOperation.setClientPath(File.createTempFile(\"Download\", \".dat\").getAbsolutePath());\n\n");
			...
			b.append("return;\n\n");
			b.append("final String downloadURL = DownloadServiceHandler.createURL(tempPath);\n\n");
			b.append("final UrlLauncher launcher = RWT.getClient().getService(UrlLauncher.class);\n");
			b.append("launcher.openURL(downloadURL);\n");
		}
	...
	public String createExportInvocationFragment() {
		...
		formGenerator.addErrorLog(b, "Error while performing data export!", "ex");
	...
	public String createDownloadFragmentForExport() {
		...
		b.append("\n");
		b.append("final File file = File.createTempFile(\"ExportFile\", \".");
		b.append(exchangeMethod.getDefaultFileExtension());
		b.append("\");\n");
		b.append("fw = new FileWriter(file);\n\n");
		b.append("if(exportContent != null)\n");
		b.append("fw.write(exportContent);\n\n");
		b.append("final String downloadURL = DownloadServiceHandler.createURL(file.getAbsolutePath());\n\n");
		b.append("final UrlLauncher launcher = RWT.getClient().getService(UrlLauncher.class);\n");
		b.append("launcher.openURL(downloadURL);\n");
		b.append("}\n");
		b.append("catch (final Exception ex)\n");
		...
		formGenerator.addWarningLog(b, "Could not close file writer!", "e");
