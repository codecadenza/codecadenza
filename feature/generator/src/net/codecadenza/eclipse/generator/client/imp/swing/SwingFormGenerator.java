 ...
 */
package net.codecadenza.eclipse.generator.client.imp.swing;

import net.codecadenza.eclipse.generator.client.IFormGenerator;
import net.codecadenza.eclipse.generator.client.imp.swing.form.SwingGridPanelGenerator;
import net.codecadenza.eclipse.generator.client.imp.swing.form.SwingSingleRecordFormGenerator;
import net.codecadenza.eclipse.generator.client.imp.swing.view.SwingListOfValuesGenerator;
import net.codecadenza.eclipse.generator.client.imp.swing.view.SwingNavigatorGenerator;
import net.codecadenza.eclipse.generator.client.imp.swing.view.SwingTreeViewGenerator;
import net.codecadenza.eclipse.generator.client.imp.swing.view.SwingViewGenerator;
...
/**
 * <p>
 * Generator for forms of a Swing application
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class SwingFormGenerator implements IFormGenerator {
	/*
	 * (non-Javadoc)
	...
	public void createNavigator(Project project) throws Exception {
		new SwingNavigatorGenerator(project).createSourceFile();
	}
	...
	public void createGridPanel(FormPanel panel) throws Exception {
		new SwingGridPanelGenerator(panel).createSourceFile();
	}
	...
	public void createForm(Form form) throws Exception {
		...
		if (formType == FormTypeEnumeration.CREATE || formType == FormTypeEnumeration.ADD || formType == FormTypeEnumeration.UPDATE
			...
			new SwingSingleRecordFormGenerator(form).createSourceFile();
			return;
		}

		if (formType == FormTypeEnumeration.SIMPLE_VIEW || formType == FormTypeEnumeration.SEARCHABLE_VIEW)
			new SwingViewGenerator(form).createSourceFile();
		else if (formType == FormTypeEnumeration.LOV)
			new SwingListOfValuesGenerator(form).createSourceFile();
		else if (formType == FormTypeEnumeration.TREE_VIEW)
			new SwingTreeViewGenerator((TreeView) form).createSourceFile();
