 ...
 * @version 1.0.0
 */
public class SwingIntLinkFieldGenerator extends AbstractSwingFieldGenerator {
	 ...
	 * @param formGenerator
	 */
	public SwingIntLinkFieldGenerator(FormField field, AbstractJavaSourceGenerator formGenerator) {
