 ...
 * @version 1.0.0
 */
public class JSFSelectionByParentFormFieldGenerator extends AbstractJSFFieldGenerator {
	 ...
	 * @param formGenerator
	 */
	public JSFSelectionByParentFormFieldGenerator(FormField field, AbstractJavaSourceGenerator formGenerator) {
	...
	public String getCreateInitializationFragment() {
		...
		b.append(pkAttr.getDomainAttribute().convertFromString(SEL_OBJ_ID));
		b.append("));\n");
