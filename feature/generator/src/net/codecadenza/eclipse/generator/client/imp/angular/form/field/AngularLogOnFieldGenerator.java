 ...
 * @version 1.0.0
 */
public class AngularLogOnFieldGenerator extends AbstractAngularFieldGenerator {
	 ...
	 * @param formatter
	 */
	public AngularLogOnFieldGenerator(FormField field, AngularContentFormatter formatter) {
	...
	public void addBindingFragment() {
		...
		fieldDef.append("this.authService.getLoggedOnUser()." + logOnDTO.getPKAttribute().getName() + " });");
