 ...
 * @version 1.0.0
 */
public class SwingLabelFieldGenerator extends AbstractSwingFieldGenerator {
	 ...
	 * @param formGenerator
	 */
	public SwingLabelFieldGenerator(FormField field, AbstractJavaSourceGenerator formGenerator) {
	...
	public void addFieldDeclaration() {
		...
		formGenerator.addPrivateField("JLabel", field.getName()).create();
	}
