 ...
 * @version 1.0.0
 */
public class EclipseLogOnFieldGenerator extends AbstractEclipseFieldGenerator {
	 ...
	 * @param formGenerator
	 */
	public EclipseLogOnFieldGenerator(FormField field, AbstractJavaSourceGenerator formGenerator) {
	...
	public String getSaveDataFragment(String objectName) {
		...
		if (project.isBoundaryMode()) {
			b.append(objectName + "." + setter + "(new " + listDTO.getModelClassName() + "(" + SECURITY_MANAGER);
		}
		else {
			...
			b.append("(" + listDTO.getModelClassName() + ".class, " + SECURITY_MANAGER);
		}

		b.append(".getLogOnDTO()." + logOnDTO.getPKAttribute().getGetterName() + "));\n\n");
