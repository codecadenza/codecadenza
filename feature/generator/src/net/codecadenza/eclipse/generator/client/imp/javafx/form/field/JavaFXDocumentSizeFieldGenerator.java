 ...
 * @version 1.0.0
 */
public class JavaFXDocumentSizeFieldGenerator extends AbstractJavaFXFieldGenerator {
	/**
	 * Constructor
	 * @param field
	 * @param formGenerator
	 */
	public JavaFXDocumentSizeFieldGenerator(FormField field, AbstractJavaSourceGenerator formGenerator) {
