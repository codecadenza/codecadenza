...
/**
 * <p>
 * Generator for dialogs to change the password of the currently logged on user
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class JavaFXChangePasswordDialogGenerator extends AbstractJavaSourceGenerator {
	 ...
	 * @param project
	 */
	public JavaFXChangePasswordDialogGenerator(Project project) {
	...
	protected void addConstructors() {
		...
		addConstructor(CHANGE_PWD_DLG_NAME + "(Window owner)", b.toString());
	}
	...
	protected void addMethods() {
		...
		final String errorMsg = i18n.getI18NMessage("msg_err_save", "Error while performing save operation!");

		addErrorLog(b, "Error while saving new password!", "ex");

		b.append("\n");
		b.append("DialogUtil.openErrorDialog(" + CHANGE_PWD_DLG_NAME + ".this, " + errorMsg + ", ex);\n");
