 ...
 */
package net.codecadenza.eclipse.generator.client.imp.eclipse.security;
 ...
 * @version 1.0.0
 */
public class EclipseChangePasswordDialogGenerator extends AbstractJavaSourceGenerator {
	 ...
	 * @param project
	 */
	public EclipseChangePasswordDialogGenerator(Project project) {
	...
	protected void addImports() {
		...
		addImports(new EclipseSecurityHelper(project).getSecurityManagerImports());
	...
	protected void addConstructors() {
		...
		addConstructor(CHANGE_PWD_DLG_NAME + "(Shell parentShell)", b.toString());
	}
	...
	protected void addMethods() {
		...
		b.append("\n");
		b.append("MessageDialog.openError(parentShell, " + msgTitle + ", " + msgText + " + ex.getMessage());\n");
		b.append("}\n");
