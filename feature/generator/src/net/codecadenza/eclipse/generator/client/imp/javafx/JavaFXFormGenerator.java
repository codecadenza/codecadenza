 ...
 */
package net.codecadenza.eclipse.generator.client.imp.javafx;

import net.codecadenza.eclipse.generator.client.IFormGenerator;
import net.codecadenza.eclipse.generator.client.imp.javafx.form.JavaFXGridPanelGenerator;
import net.codecadenza.eclipse.generator.client.imp.javafx.form.JavaFXSingleRecordFormGenerator;
import net.codecadenza.eclipse.generator.client.imp.javafx.view.JavaFXListOfValuesGenerator;
import net.codecadenza.eclipse.generator.client.imp.javafx.view.JavaFXNavigatorGenerator;
import net.codecadenza.eclipse.generator.client.imp.javafx.view.JavaFXTreeViewGenerator;
import net.codecadenza.eclipse.generator.client.imp.javafx.view.JavaFXViewGenerator;
...
/**
 * <p>
 * Generator for forms of a JavaFX application
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class JavaFXFormGenerator implements IFormGenerator {
	/*
	 * (non-Javadoc)
	...
	public void createNavigator(Project project) throws Exception {
		new JavaFXNavigatorGenerator(project).createSourceFile();
	}
	...
	public void createGridPanel(FormPanel panel) throws Exception {
		new JavaFXGridPanelGenerator(panel).createSourceFile();
	}
	...
	public void createForm(Form form) throws Exception {
		...
		if (formType == FormTypeEnumeration.CREATE || formType == FormTypeEnumeration.ADD || formType == FormTypeEnumeration.UPDATE
			...
			new JavaFXSingleRecordFormGenerator(form).createSourceFile();
			return;
		}

		if (formType == FormTypeEnumeration.SIMPLE_VIEW || formType == FormTypeEnumeration.SEARCHABLE_VIEW)
			new JavaFXViewGenerator(form).createSourceFile();
		else if (formType == FormTypeEnumeration.LOV)
			new JavaFXListOfValuesGenerator(form).createSourceFile();
		else if (formType == FormTypeEnumeration.TREE_VIEW)
			new JavaFXTreeViewGenerator((TreeView) form).createSourceFile();
