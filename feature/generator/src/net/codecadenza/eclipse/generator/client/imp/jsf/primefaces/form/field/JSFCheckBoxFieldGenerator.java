 ...
 * @version 1.0.0
 */
public class JSFCheckBoxFieldGenerator extends AbstractJSFFieldGenerator {
	/**
	 * Constructor
	 * @param field
	 * @param formGenerator
	 */
	public JSFCheckBoxFieldGenerator(FormField field, AbstractJavaSourceGenerator formGenerator) {
	...
	public String getCreateInitializationFragment() {
		...
		b.append(modelObjectName + "." + setter + "(true);\n");
	...
	public String getFieldDefinitionFragment(boolean hasOneColumn) {
		...
		b.append("\t\t<p:selectBooleanCheckbox ");
