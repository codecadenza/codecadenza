 ...
 * @version 1.0.0
 */
public class JavaFXCheckBoxFieldGenerator extends AbstractJavaFXFieldGenerator {
	/**
	 * Constructor
	 * @param field
	 * @param formGenerator
	 */
	public JavaFXCheckBoxFieldGenerator(FormField field, AbstractJavaSourceGenerator formGenerator) {
	...
	public void addFieldDeclaration() {
		...
		formGenerator.addPrivateField("CheckBox", field.getName()).create();
	}
	...
	public String getDefaultInitializationFragment() {
		...
		b.append(field.getName() + ".setSelected(" + modelObjectName + "." + getter + ");\n");
	...
	public String getCreateInitializationFragment() {
		...
		b.append(field.getName() + ".setSelected(true);\n");
	...
	public String getSaveDataFragment(String objectName) {
		...
		if (!field.isVisible() || field.isReadonly()) {
			...
			if (field.getDefaultValue() != null && !field.getDefaultValue().isEmpty())
				b.append(objectName + "." + setter + "(true);\n");
		}
		else
			b.append(objectName + "." + setter + "(" + field.getName() + ".isSelected());\n");
	...
	public String getFieldDefinitionFragment(boolean hasOneColumn) {
		...
		final var b = new StringBuilder();
		b.append(field.getName() + " = new CheckBox();\n");
