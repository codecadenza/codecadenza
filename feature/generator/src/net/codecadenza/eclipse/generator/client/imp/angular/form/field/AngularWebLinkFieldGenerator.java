 ...
 * @version 1.0.0
 */
public class AngularWebLinkFieldGenerator extends AbstractAngularFieldGenerator {
	/**
	 * Constructor
	 * @param field
	 * @param formatter
	 */
	public AngularWebLinkFieldGenerator(FormField field, AngularContentFormatter formatter) {
	...
	protected String addControlToTemplate() {
		...
		control.append("<cc-weblink formControlName=\"" + field.getDTOAttribute().getName() + "\" ");
		control.append("id=\"" + field.getName() + "\"></cc-weblink>");
