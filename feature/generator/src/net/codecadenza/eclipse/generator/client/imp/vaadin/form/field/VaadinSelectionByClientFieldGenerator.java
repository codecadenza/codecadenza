 ...
 * @version 1.0.0
 */
public class VaadinSelectionByClientFieldGenerator extends AbstractVaadinFieldGenerator {
	 ...
	 * @param formGenerator
	 */
	public VaadinSelectionByClientFieldGenerator(FormField field, AbstractJavaSourceGenerator formGenerator) {
	...
	public String getSaveDataFragment(String objectName) {
		...
		if (project.isBoundaryMode()) {
			...
			b.append("(" + MANAGED_SECURITY_MANAGER + ".getLogOnDTO()." + clientPKAttr.getGetterName() + "));\n");
		}
		else {
			...
			b.append(".class, " + MANAGED_SECURITY_MANAGER + ".getLogOnDTO()." + clientPKAttr.getGetterName() + "));\n");
		}
