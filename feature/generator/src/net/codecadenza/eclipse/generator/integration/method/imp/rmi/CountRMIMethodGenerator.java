 ...
 * @version 1.0.0
 */
public class CountRMIMethodGenerator extends BasicRMIMethodGenerator {
	/**
	 * Constructor
	 * @param rmiMethod
	 * @param parentGenerator
	 */
	public CountRMIMethodGenerator(RMIIntegrationMethod rmiMethod, AbstractJavaSourceGenerator parentGenerator) {
	...
	public String createMethodLogic() {
		...
		final BoundaryMethod searchMethod = rmiMethod.getBoundaryMethod().getSearchMethod();
		final DTOBean dto;
