...
/**
 * <p>
 * Dialog for creating a form group
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class CreateFormGroupDialog extends AbstractDialog {
	private static final String SHELL_TITLE = "Create new form group";
	 ...
	 * @param name
	 */
	public CreateFormGroupDialog(SWTWorkbenchBot bot, String name) {
	...
	public void enterData() {
		...
		for (int rowIndex = 0; rowIndex < tabRoles.rowCount(); rowIndex++)
			tabRoles.getTableItem(rowIndex).check();
