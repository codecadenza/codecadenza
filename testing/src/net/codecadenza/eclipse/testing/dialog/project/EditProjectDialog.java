...
/**
 * <p>
 * Dialog to edit a CodeCadenza project
 * </p>
 * <p>
...
public class EditProjectDialog extends AbstractDialog {
	private static final String SHELL_TITLE = "Edit project";
	private static final String TAB_ITEM_SUB_PACKAGES = "Sub-packages";

	/**
	 * Constructor
	 * @param bot
	 */
	public EditProjectDialog(SWTWorkbenchBot bot) {
	...
	public void enterData() {
		// Add a new namespace to the project
		bot.tabItem(TAB_ITEM_SUB_PACKAGES).activate();
		bot.button(CMD_ADD).click();
		bot.text().setText(Project.ADDITIONAL_NAMESPACE);
