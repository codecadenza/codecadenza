 ...
 * @version 1.0.0
 */
public class EditRoleDialog extends AbstractDialog {
	private static final String SHELL_TITLE = "Edit role";
	 ...
	 * @param name
	 */
	public EditRoleDialog(SWTWorkbenchBot bot, String name) {
