...
/**
 * <p>
 * Dialog for creating a data exchange attribute
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class CreateExchangeAttributeDialog extends AbstractDialog {
	private static final String ATTRIBUTE_NAME = "simpleAttribute";
	...
	private static final String MAPPED_ATTRIBUTE_NAME = "mappedAttribute";
	private static final String SHELL_TITLE = "Add new data exchange attribute to element '";
	 ...
	 * @param mapped
	 */
	public CreateExchangeAttributeDialog(SWTWorkbenchBot bot, String elementName, boolean mapped) {
		super(bot, SHELL_TITLE + elementName + "'");
