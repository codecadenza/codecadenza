...
/**
 * <p>
 * Dialog for creating view forms
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class CreateViewFormDialog extends AbstractDialog {
	private static final String LBL_FORM_TYPE = "Form type:";
	private static final String LBL_DOMAIN_OBJECT = "Domain object:";
	private static final String LBL_TITLE = "Title:";
	private static final String SHELL_TITLE = "Create new view form";
	 ...
	 * @param formType
	 */
	public CreateViewFormDialog(SWTWorkbenchBot bot, DomainObject domainObject, FormType formType) {
	...
	public void enterData() {
		...
		if (formType != FormType.LOV)
			bot.textWithLabel(LBL_TITLE).setText(domainObject.getViewFormTitle());
