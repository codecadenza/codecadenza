 ...
 * @version 1.0.0
 */
public class CreateDefaultFormsDialog extends AbstractDialog {
	private static final String LBL_DOMAIN_OBJECT = "Select a domain object:";
	private static final String SHELL_TITLE = "Create default forms";
	 ...
	 */
	public CreateDefaultFormsDialog(SWTWorkbenchBot bot, String domainObjectName) {
