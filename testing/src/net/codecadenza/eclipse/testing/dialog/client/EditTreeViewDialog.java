 ...
 * @version 1.0.0
 */
public class EditTreeViewDialog extends AbstractDialog {
	private static final String SHELL_TITLE = "Edit tree view";

	/**
	 * Constructor
	 * @param bot
	 */
	public EditTreeViewDialog(SWTWorkbenchBot bot) {
