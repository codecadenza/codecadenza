 ...
 * @version 1.0.0
 */
public class CreateManyToManyAssociationDialog extends AbstractDialog {
	private static final String SHELL_TITLE = "Create new many-to-many association";

	/**
	 * Constructor
	 * @param bot
	 */
	public CreateManyToManyAssociationDialog(SWTWorkbenchBot bot) {
