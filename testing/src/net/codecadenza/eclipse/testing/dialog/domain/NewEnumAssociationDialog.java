...
/**
 * <p>
 * Dialog for creating an enumeration association
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class NewEnumAssociationDialog extends AbstractDialog {
	private static final String SHELL_TITLE = "Create new enumeration association";
	 ...
	 */
	public NewEnumAssociationDialog(SWTWorkbenchBot bot, EnumAssociation enumAssociation) {
		super(bot, SHELL_TITLE);

		this.enumAssociation = enumAssociation;
	}
	...
	public void enterData() {
		...
		for (final char character : enumAssociation.getName().toCharArray())
			txtName.pressShortcut(Keystrokes.create(character));
