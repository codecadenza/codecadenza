...
/**
 * <p>
 * Dialog to enter the delay of a GUI test action
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class DelayInputDialog extends AbstractDialog {
	private static final String DEFAULT_DELAY = "1000";
	private static final String SHELL_TITLE = "Enter a delay after executing the test action";

	/**
	 * Constructor
	 * @param bot
	 */
	public DelayInputDialog(SWTWorkbenchBot bot) {
	...
	public void enterData() {
		bot.text().setText(DEFAULT_DELAY);
