...
/**
 * <p>
 * Dialog for performing a login operation
 * </p>
 * <p>
...
public class LoginDialog extends AbstractDialog {
	...
	private static final String SHELL_TITLE = "Create new login test action";

	/**
	 * Constructor
	 * @param bot
	 */
	public LoginDialog(SWTWorkbenchBot bot) {
	...
	public void enterData() {
		bot.textWithLabel(LBL_USER_NAME).setText(DEFAULT_USER_NAME);
