...
/**
 * <p>
 * Validator for checking if a {@link String} matches a given regular expression
 * </p>
 * <p>
...
public class StringRegExValidator extends RegexpValidator {
	 ...
	 * @param locale
	 */
	public StringRegExValidator(String regEx, Locale locale) {
		super(new ValidationMessageBuilder(locale).buildMessage(regEx), regEx);
	}
