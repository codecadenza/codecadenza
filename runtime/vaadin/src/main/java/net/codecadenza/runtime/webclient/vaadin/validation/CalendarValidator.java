...
/**
 * <p>
 * Validator for checking if a {@link Calendar} is inside a given range
 * </p>
 * <p>
...
public class CalendarValidator extends RangeValidator<Calendar> {
	 ...
	 * @param locale
	 */
	public CalendarValidator(Calendar minValue, Calendar maxValue, Locale locale) {
	 ...
	 * @param locale
	 */
	public CalendarValidator(Calendar maxValue, Locale locale) {
