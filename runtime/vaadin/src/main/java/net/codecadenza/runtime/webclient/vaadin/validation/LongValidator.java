...
/**
 * <p>
 * Validator for checking if a {@link Long} is inside a given range
 * </p>
 * <p>
...
public class LongValidator extends LongRangeValidator {
	 ...
	 * @param locale
	 */
	public LongValidator(Long minValue, Long maxValue, Locale locale) {
	 ...
	 * @param locale
	 */
	public LongValidator(Long maxValue, Locale locale) {
