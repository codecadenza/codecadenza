...
/**
 * <p>
 * Validator for checking if a {@link Float} is inside a given range
 * </p>
 * <p>
...
public class FloatValidator extends FloatRangeValidator {
	 ...
	 * @param locale
	 */
	public FloatValidator(Float minValue, Float maxValue, Locale locale) {
	 ...
	 * @param locale
	 */
	public FloatValidator(Float maxValue, Locale locale) {
