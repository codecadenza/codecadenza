...
/**
 * <p>
 * {@link String} to {@link Float} converter that uses a given format pattern
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class StringToFloatConverter extends com.vaadin.flow.data.converter.StringToFloatConverter {
	 ...
	 * @param locale
	 */
	public StringToFloatConverter(String numberFormatPattern, Locale locale) {
