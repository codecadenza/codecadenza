...
/**
 * <p>
 * Validator for checking if a {@link LocalDateTime} is inside a given range
 * </p>
 * <p>
...
public class LocalDateTimeValidator extends RangeValidator<LocalDateTime> {
	 ...
	 * @param locale
	 */
	public LocalDateTimeValidator(LocalDateTime minValue, LocalDateTime maxValue, Locale locale) {
	 ...
	 * @param locale
	 */
	public LocalDateTimeValidator(LocalDateTime maxValue, Locale locale) {
