...
/**
 * <p>
 * Validator for checking if a {@link Double} is inside a given range
 * </p>
 * <p>
...
public class DoubleValidator extends DoubleRangeValidator {
	 ...
	 * @param locale
	 */
	public DoubleValidator(Double minValue, Double maxValue, Locale locale) {
	 ...
	 * @param locale
	 */
	public DoubleValidator(Double maxValue, Locale locale) {
