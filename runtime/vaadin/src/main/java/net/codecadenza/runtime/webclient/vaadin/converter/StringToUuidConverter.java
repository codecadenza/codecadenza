...
import static net.codecadenza.runtime.webclient.vaadin.i18n.InternalI18NService.MSG_UUID_CONVERSION_ERROR;
...
/**
 * <p>
 * {@link String} to {@link UUID} converter that provides a predefined error message
 * </p>
 * <p>
...
public class StringToUuidConverter extends com.vaadin.flow.data.converter.StringToUuidConverter {
	...
	public StringToUuidConverter(Locale locale) {
		super(new InternalI18NService(locale).getTranslation(MSG_UUID_CONVERSION_ERROR));
	}
