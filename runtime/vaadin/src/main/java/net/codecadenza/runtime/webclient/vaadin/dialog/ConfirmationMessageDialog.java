...
public class ConfirmationMessageDialog extends AbstractMessageDialog {
	...
	protected void addButtons(DialogFooter dialogFooter) {
		...
		cmdYes.setId("cmdYes");
		cmdYes.addClickListener(_ -> fireButtonClickEvent(ButtonType.YES));

		final var cmdNo = new Button(i18n.getTranslation(CMD_NO));
		cmdNo.setId("cmdNo");
		cmdNo.addClickListener(_ -> fireButtonClickEvent(ButtonType.NO));
		...
		dialogFooter.add(cmdYes, cmdNo, cmdCancel);
	}
