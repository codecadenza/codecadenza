...
/**
 * <p>
 * Value provider for columns that are mapped to a {@link Float} field. The values are converted to a string by using the provided
 * decimal format.
 * </p>
 * <p>
...
public class FloatValueProvider<T> implements ValueProvider<T, String> {
	 ...
	 * @param input
	 */
	public FloatValueProvider(String decimalFormat, ValueProvider<T, Float> input) {
		this.input = input;
	...
	public String apply(T source) {
		final Float value = input.apply(source);
