...
public interface FileJMSService {
	 ...
	 * @param maxWaitTime the maximum time to wait for the response. If null, the timeout never expires!
	 * @throws IOException if the download operation has failed
	 */
	void downloadFile(String pathOnServer, File targetFile, Duration maxWaitTime) throws IOException;
	 ...
	 */
	String uploadFile(File file, Duration maxWaitTime) throws FileNotFoundException;
