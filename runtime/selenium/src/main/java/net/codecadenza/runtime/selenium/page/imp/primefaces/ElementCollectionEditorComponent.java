 ...
 * @version 1.0.0
 */
public class ElementCollectionEditorComponent extends AbstractPrimefacesPageComponent {
	private static final String ADD_BUTTON_ID_SUFFIX = "Add";
	...
	public ElementCollectionEditorComponent(AbstractPageObject pageObject, String elementId) {
		...
		this.tableXPath = "//div[@id='" + elementId + TABLE_ID_SUFFIX + "']//tbody";
	...
	public void addElements(PageElementTestData testData, boolean removeExistingElements) {
		...
		for (final String element : elements) {
			final WebElement inputField = findWebElementByXPath("//input[@id='" + elementId + INPUT_ID_SUFFIX + "']");
			inputField.clear();
	...
	protected void removeAllElements() {
		...
		final String menuItemId = elementId + "_" + MENU_ITEM_DELETE_ALL;
	...
	protected WebElement getFirstRow() {
		...
		final WebElement row = findWebElementByXPath(tableXPath + "/tr[1]");
