...
/**
 * <p>
 * Mapper for all kinds of exceptions that are not part of JAX-RS. Note that an application can add any number of mappers for
 * specific exceptions in order return a more appropriate status code rather than HTTP {@code 500}!
 * </p>
 * <p>
...
public class StandardExceptionMapper extends AbstractExceptionMapper<Exception> {
	 ...
	 */
	@Override
	protected StatusType getStatus(Exception t) {
