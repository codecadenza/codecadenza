...
/**
 * <p>
 * XML mapping for {@link ReturnValue} objects
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
public class XMLReturnValue implements ReturnValue {
	private List<TestObject> testObjects;

	/*
	 * (non-Javadoc)
	 * @see net.codecadenza.runtime.ddt.model.ReturnValue#getTestObjects()
	 */
	@Override
