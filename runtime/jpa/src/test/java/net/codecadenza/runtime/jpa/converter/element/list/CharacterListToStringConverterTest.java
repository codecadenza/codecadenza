...
/**
 * <p>
 * Test the {@link CharacterListToStringConverter}
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
class CharacterListToStringConverterTest {
	private static final char VALUE_1 = '\u263A';
	private static final char VALUE_2 = 'H';

	private final CharacterListToStringConverter converter = new CharacterListToStringConverter();

	@Test
	void testConvert() {
		final List<Character> values = List.of(VALUE_1, VALUE_2);
