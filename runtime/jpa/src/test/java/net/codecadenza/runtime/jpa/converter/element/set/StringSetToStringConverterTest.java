...
/**
 * <p>
 * Test the {@link StringSetToStringConverter}
 * </p>
 * <p>
...
class StringSetToStringConverterTest {
	...
	private final StringSetToStringConverter converter = new StringSetToStringConverter();

	@Test
	void testConvert() {
		final Set<String> values = Set.of(VALUE_1, VALUE_2);
