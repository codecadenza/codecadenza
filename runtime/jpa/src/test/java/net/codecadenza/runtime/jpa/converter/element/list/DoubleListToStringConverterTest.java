...
/**
 * <p>
 * Test the {@link DoubleListToStringConverter}
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
class DoubleListToStringConverterTest {
	private static final double VALUE_1 = 113.0123456789;
	private static final double VALUE_2 = -13.9876543211;

	private final DoubleListToStringConverter converter = new DoubleListToStringConverter();

	@Test
	void testConvert() {
		final List<Double> values = List.of(VALUE_1, VALUE_2);
