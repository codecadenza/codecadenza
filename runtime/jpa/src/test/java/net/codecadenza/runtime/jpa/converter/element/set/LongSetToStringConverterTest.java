...
/**
 * <p>
 * Test the {@link LongSetToStringConverter}
 * </p>
 * <p>
...
class LongSetToStringConverterTest {
	private static final long VALUE_1 = 113L;
	private static final long VALUE_2 = -13L;

	private final LongSetToStringConverter converter = new LongSetToStringConverter();

	@Test
	void testConvert() {
		final Set<Long> values = Set.of(VALUE_1, VALUE_2);
