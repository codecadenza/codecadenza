...
/**
 * <p>
 * Test the {@link StringListToStringConverter}
 * </p>
 * <p>
...
class StringListToStringConverterTest {
	...
	private final StringListToStringConverter converter = new StringListToStringConverter();

	@Test
	void testConvert() {
		final List<String> values = List.of(VALUE_1, VALUE_2);
