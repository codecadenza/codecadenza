...
/**
 * <p>
 * Test the {@link LocalDateTimeListToStringConverter}
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
class LocalDateTimeListToStringConverterTest {
	private static final String VALUE_1 = "01.02.2025 11:21:13";
	private static final String VALUE_2 = "02.02.2025 12:01:00";

	private final LocalDateTimeListToStringConverter converter = new LocalDateTimeListToStringConverter();

	@Test
	void testConvert() {
		final DateTimeFormatter dateTimeFormat = DateTimeFormatter.ofPattern(LocalDateTimeListToStringConverter.DATE_TIME_FORMAT)
		...
		final List<LocalDateTime> values = List.of(value1, value2);
