...
/**
 * <p>
 * Converter for lists containing values of type {@link GregorianCalendar}
 * </p>
 * <p>
 ...
 */
@Converter
public class GregorianCalendarListToStringConverter extends AbstractListToStringConverter<GregorianCalendar> {
	public static final String DATE_TIME_FORMAT = "dd.MM.yyyy HH:mm:ss";
	private static final ValueConverter<GregorianCalendar> valueConverter = new ValueConverter<>(null, DATE_TIME_FORMAT, null,
	 ...
	 */
	@Override
	protected GregorianCalendar convertToValue(String string) {
