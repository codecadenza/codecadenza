...
/**
 * <p>
 * Converter for lists containing values of type {@link Date}
 * </p>
 * <p>
 ...
 */
@Converter
public class DateListToStringConverter extends AbstractListToStringConverter<Date> {
	public static final String DATE_TIME_FORMAT = "dd.MM.yyyy HH:mm:ss";
	private static final ValueConverter<Date> valueConverter = new ValueConverter<>(null, DATE_TIME_FORMAT, null, Date.class);
	 ...
	 */
	@Override
	protected Date convertToValue(String string) {
