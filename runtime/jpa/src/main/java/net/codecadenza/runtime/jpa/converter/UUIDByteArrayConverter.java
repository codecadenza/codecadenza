...
/**
 * <p>
 * Converter that is required for mapping fields of type {@link UUID} to a byte array
 * </p>
 * <p>
 ...
 */
@Converter
public class UUIDByteArrayConverter implements AttributeConverter<UUID, byte[]> {
	/*
	 * (non-Javadoc)
	...
	public UUID convertToEntityAttribute(byte[] dbData) {
		...
		final var byteBuffer = ByteBuffer.wrap(dbData);
