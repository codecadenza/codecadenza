 ...
 * @version 1.0.0
 */
@FacesConverter("net.codecadenza.runtime.webclient.primefaces.converter.FileSizeLongConverter")
public class FileSizeLongConverter implements Converter<Long> {
	/*
	 * (non-Javadoc)
	 ...
	 */
	@Override
	public Long getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
	 ...
	 */
	@Override
	public String getAsString(FacesContext facesContext, UIComponent component, Long value) {
		if (value == null)
			return "";
