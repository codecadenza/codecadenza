...
/**
 * <p>
 * JSF converter for fields of type {@link LocalDateTime}
 * </p>
 * <p>
 ...
 * @version 1.0.0
 */
@FacesConverter("net.codecadenza.runtime.webclient.primefaces.converter.LocalDateTimeConverter")
public class LocalDateTimeConverter implements Converter<LocalDateTime> {
	 ...
	 */
	@Override
	public LocalDateTime getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
		...
		return LocalDateTime.parse(submittedValue,
	 ...
	 */
	@Override
	public String getAsString(FacesContext facesContext, UIComponent component, LocalDateTime value) {
		if (value == null)
			return "";
